...
public class VistaJuego {
    ...
    public void mostrarMultiplicadores(Pregunta pregunta, int cualJugador){
        if(!panel.jugadorTieneMultiplicador(cualJugador, 2) && !panel.jugadorTieneMultiplicador(cualJugador, 3)){
        ...
        if(!panel.jugadorTieneMultiplicador(cualJugador, 2)){
            multiplicadorX2.setDisable(true);
        }else if(!panel.jugadorTieneMultiplicador(cualJugador, 3)){
